...
if __name__=='__main__':
    ...
    while not rospy.is_shutdown():
        ...
        try:
            ...
            print('done')
            try:
                request = rospy.ServiceProxy('innovation', NuSrv)
                print('request')
                print(request)

                #magic thing here... had to do 'origin_tag=' to get it to not error
                request(origin_tag=ar_tags['arZ'])
                #request(origin_tag = 'usb_cam')
                print('hi')
